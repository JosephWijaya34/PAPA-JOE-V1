            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-12 d-flex justify-content-center">
                    <ul id="menu-flters">
                        ...
                        <li data-filter=".filter-Halal">Halal</li>
                        <li data-filter=".filter-Non - Halal">Non - Halal</li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-4">
                    <div class="info">
                        <div class="address">
                            ...
                            <h4>Location:</h4>
                            <p>Darmo Permai Selatan, Surabaya</p>
                        </div>
                        ...
                        <div class="open-hours">
                            ...
                            <h4>Open Hours:</h4>
                            <p>
                                Monday-Saturday:<br> 12:00 PM - 18.00 PM
                            </p>
                        </div>
